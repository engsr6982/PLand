  ...
  "land": {
    ...
    "bought": {
      ...
      "dimensionPriceCoefficients": {
        ...
        "defaultperm": {//领地创建时的默认权限开关
            "allowFireSpread": true,
            "allowAttackDragonEgg": false,
            "allowFarmDecay": true,
            "allowPistonPushOnBoundary": true,
            "allowRedstoneUpdate": true,
            "allowExplode": false,
            "allowBlockFall": false,
            "allowDestroy": false,
            "allowWitherDestroy": false,
            "allowPlace": false,
            "allowPlayerDamage": false,
            "allowMonsterDamage": true,
            "allowPassiveDamage": false,
            "allowSpecialDamage": false,
            "allowCustomSpecialDamage": false,
            "allowOpenChest": false,
            "allowPickupItem": false,
            "allowEndermanLeaveBlock": false,
            "allowDropItem": true,
            "allowProjectileCreate": false,
            "allowRideEntity": false,
            "allowRideTrans": false,
            "allowAxePeeled": false,
            "allowLiquidFlow": true,
            "allowSculkBlockGrowth": true,
            "allowMonsterSpawn": true,
            "allowAnimalSpawn": true,
            "allowInteractEntity": false,
            "allowActorDestroy": false,
            "useAnvil": false,
            "useBarrel": false,
            "useBeacon": false,
            "useBed": false,
