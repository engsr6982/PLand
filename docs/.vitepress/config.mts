...
export default withMermaid(
    defineConfig({
        ...
        // GitHub Pages 项目站点部署在 /PLand/ 路径下
        base: '/PLand/',
        ...
        themeConfig: {
            ...
            nav: [
                { text: '更新日志', link: 'https://github.com/IceBlcokMC/PLand/blob/main/CHANGELOG.md' },
            ...
            sidebar: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { text: 'Bug 反馈(新功能请求)', link: 'https://github.com/IceBlcokMC/PLand/issues' },
                    ],
                },
            ],
            ...
            footer: {
                ...
                copyright: 'Copyright © 2024-2026 PLand Contributors',
            },
        },
    })
);
